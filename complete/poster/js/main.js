void (function () {
  var posterList = [
    { name: '安荣', year: '2017、2020', prize: '最佳开发奖、最佳拓展奖', type: 1 },
    { name: '白小飞', year: '2018、2020', prize: '年度敬业奖、年度敬业奖', type: 1 },
    { name: '曾辉', year: '2014', prize: '安博通之星', type: 1 },
    { name: '车源', year: '2019', prize: '最佳支撑奖', type: 1 },
    { name: '陈王英才', year: '2020', prize: '最佳支撑奖', type: 1 },
    { name: '陈伟鹏', year: '2016', prize: '最佳拓展奖', type: 1 },
    { name: '崔彩霞', year: '2018', prize: '最佳测试奖', type: 1 },
    { name: '段彬', year: '2013', prize: '安博通之星', type: 1 },
    { name: '范俊杰', year: '2017', prize: '最佳拓展奖', type: 1 },
    { name: '冯坤', year: '2020', prize: '最佳开发奖', type: 1 },
    { name: '顾梦楠', year: '2018', prize: '最佳拓展奖', type: 1 },
    { name: '郭泽生', year: '2016、2019', prize: '最佳测试奖、最佳测试奖', type: 1 },
    { name: '韩亚飞', year: '2016', prize: '年度敬业奖', type: 1 },
    { name: '胡星', year: '2020', prize: '最佳测试奖', type: 1 },
    { name: '胡星星', year: '2019', prize: '最佳开发奖', type: 1 },
    { name: '黄忠雷', year: '2019', prize: '最佳新人奖', type: 1 },
    { name: '金晨良子', year: '2020', prize: '最佳新人奖', type: 1 },
    { name: '冷武超', year: '2018', prize: '最佳支撑奖', type: 1 },
    { name: '李洪宇', year: '2020', prize: '安博通之星', type: 1 },
    { name: '李欢', year: '2019', prize: '最佳新人奖', type: 1 },
    { name: '李萌', year: '2015、2016、2018', prize: '最佳新人奖、最佳开发奖、最佳开发奖', type: 1 },
    { name: '李晴', year: '2020', prize: '最佳新人奖', type: 1 },
    { name: '李先瞧', year: '2016', prize: '最佳新人奖', type: 1 },
    { name: '李响', year: '2015', prize: '最佳新人奖', type: 1 },
    { name: '李永辉', year: '2019', prize: '最佳新人奖', type: 1 },
    { name: '李源', year: '2018', prize: '金牌销售奖', type: 1 },
    { name: '李远', year: '2015', prize: '安博通之星', type: 1 },
    { name: '李振华', year: '2020', prize: '金牌销售奖', type: 1 },
    { name: '林丛岭', year: '2019', prize: '最佳测试奖', type: 1 },
    { name: '刘恒', year: '2019', prize: '最佳测试奖', type: 1 },
    { name: '刘琼', year: '2019', prize: '年度敬业奖', type: 1 },
    { name: '刘声明', year: '2015、2016', prize: '年度敬业奖、最佳开发奖', type: 1 },
    { name: '刘小伟', year: '2017', prize: '最佳新人奖', type: 1 },
    { name: '柳开江', year: '2018', prize: '最佳开发奖', type: 1 },
    { name: '鲁薇', year: '2019', prize: '最佳开发奖', type: 1 },
    { name: '鹿贺', year: '2014、2018', prize: '最佳拓展奖、安博通之星', type: 1 },
    { name: '梅家俊', year: '2020', prize: '最佳支撑奖', type: 1 },
    { name: '梅宇', year: '2020', prize: '最佳新人奖', type: 1 },
    { name: '牛晓峰', year: '2019', prize: '金牌销售奖', type: 1 },
    { name: '彭小雨', year: '2017', prize: '年度敬业奖', type: 1 },
    { name: '乔志巍', year: '2018', prize: '最佳产品经理奖', type: 1 },
    { name: '瞿磊', year: '2020', prize: '最佳测试奖', type: 1 },
    { name: '任作明', year: '2018', prize: '最佳支撑奖', type: 1 },
    { name: '荣艳明', year: '2017、2019、2020', prize: '最佳新人奖、最佳拓展奖、最佳拓展奖', type: 1 },
    { name: '宋红林', year: '2019、2020', prize: '最佳支撑奖、最佳支撑奖', type: 1 },
    { name: '孙祥明', year: '2017', prize: '最佳产品经理奖', type: 1 },
    { name: '唐际当', year: '2016', prize: '最佳测试奖', type: 1 },
    { name: '陶荣', year: '2020', prize: '特别贡献奖', type: 1 },
    { name: '涂兴洋', year: '2020', prize: '最佳新人奖', type: 1 },
    { name: '屠晓蕊', year: '2017、2018、2019', prize: '最佳拓展奖、金牌销售奖、金牌销售奖', type: 1 },
    { name: '汪昕祎', year: '2018', prize: '最佳新人奖', type: 1 },
    { name: '王英', year: '2019', prize: '最佳开发奖', type: 1 },
    { name: '王志杰', year: '2015、2019、2020', prize: '最佳维护奖、最佳支撑奖、最佳产品经理奖', type: 1 },
    { name: '王智齐', year: '2020', prize: '最佳产品经理奖', type: 1 },
    { name: '吴笛', year: '2016', prize: '安博通之星', type: 1 },
    { name: '肖千', year: '2019', prize: '最佳测试奖', type: 1 },
    { name: '辛豆', year: '2018', prize: '最佳测试奖', type: 1 },
    { name: '徐鹤', year: '2017、2019', prize: '最佳支撑奖、最佳产品经理奖', type: 1 },
    { name: '徐笑', year: '2019', prize: '年度敬业奖', type: 1 },
    { name: '许天奇', year: '2020', prize: '最佳支撑奖', type: 1 },
    { name: '薛洪亮', year: '2016、2017', prize: '最佳拓展奖、安博通之星', type: 1 },
    { name: '严文涛', year: '2019', prize: '最佳产品经理奖', type: 1 },
    { name: '杨帆', year: '2014', prize: '年度敬业奖', type: 1 },
    { name: '杨晓军', year: '2015、2020', prize: '最佳维护奖、最佳拓展奖', type: 1 },
    { name: '尹志勇', year: '2017、2020', prize: '最佳测试奖、最佳测试奖', type: 1 },
    { name: '袁升', year: '2020', prize: '最佳开发奖', type: 1 },
    { name: '袁泽', year: '2017、2018、2019', prize: '最佳支撑奖、最佳拓展奖、最佳拓展奖', type: 1 },
    { name: '翟世兴', year: '2019', prize: '最佳开发奖', type: 1 },
    { name: '张海华', year: '2018、2019', prize: '最佳拓展奖、最佳拓展奖', type: 1 },
    { name: '张强', year: '2014、2020', prize: '最佳维护奖、最佳测试奖', type: 1 },
    { name: '张青', year: '2020', prize: '年度敬业奖', type: 1 },
    { name: '张顺涛', year: '2018', prize: '最佳新人奖', type: 1 },
    { name: '张婷婷', year: '2020', prize: '最佳开发奖', type: 1 },
    { name: '张鑫', year: '2016', prize: '年度敬业奖', type: 1 },
    { name: '张洋', year: '2020', prize: '最佳开发奖', type: 1 },
    { name: '张中秋', year: '2020', prize: '最佳新人奖', type: 1 },
    { name: '赵亚林', year: '2020', prize: '最佳测试奖', type: 1 },
    { name: '周浩', year: '2014、2016', prize: '最佳开发奖、最佳支撑奖', type: 1 },
    { name: '周伊凡', year: '2016', prize: '最佳新人奖', type: 1 },
    { name: '朱善亮', year: '2018', prize: '最佳支撑奖', type: 1 },
    { name: '左福龙', year: '2017', prize: '最佳测试奖', type: 1 },
